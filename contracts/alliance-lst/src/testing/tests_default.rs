...
//     QueryMsg, StateResponse, UnbondRequest, UnbondRequestsByBatchResponseItem,
...
// };
// use crate::types::{
//     withdraw_delegator_reward_msg, Coins, Delegation, Redelegation, SendFee, Undelegation,
// };
...
//     assert_eq!(
//         res.messages[0],
//         SubMsg::new(withdraw_delegator_reward_msg(
...
//             total_utoken_bonded: Uint128::new(1000),
//         },
//     )?;
...
//     set_total_stake_supply(&state, &mut deps, 100000, 1000000);
...
//     assert_eq!(
//         res.messages[0].msg,
//         Delegation::new("bob", delegated.u128(), MOCK_UTOKEN)
//             .to_cosmos_msg(MOCK_CONTRACT_ADDR.to_string())
//     );
//     assert_eq!(
//         res.messages[1].msg,
...
//     assert_eq!(err, ContractError::ExpectingAllianceStakeToken("random_token".into()));
...
//     set_total_stake_supply(&state, &mut deps, 1012043, 1012043);
...
//         res.messages[0],
//         SubMsg::new(
//             Undelegation::new("alice", 31732, MOCK_UTOKEN)
//                 .to_cosmos_msg(MOCK_CONTRACT_ADDR.to_string())
//         )
//     );
//     assert_eq!(
//         res.messages[1],
//         SubMsg::new(
//             Undelegation::new("bob", 31733, MOCK_UTOKEN)
//                 .to_cosmos_msg(MOCK_CONTRACT_ADDR.to_string())
//         )
//     );
//     assert_eq!(
//         res.messages[2],
//         SubMsg::new(
//             Undelegation::new("charlie", 31732, MOCK_UTOKEN)
//                 .to_cosmos_msg(MOCK_CONTRACT_ADDR.to_string())
//         )
//     );
//     assert_eq!(
...
//         res.messages[0],
//         SubMsg::new(
//             Redelegation::new("charlie", "alice", 170833, MOCK_UTOKEN)
//                 .to_cosmos_msg(MOCK_CONTRACT_ADDR.to_string())
//         ),
//     );
//     assert_eq!(
//         res.messages[1],
//         SubMsg::new(
//             Redelegation::new("charlie", "bob", 170833, MOCK_UTOKEN)
//                 .to_cosmos_msg(MOCK_CONTRACT_ADDR.to_string())
//         ),
//     );
...
//     )
//     .unwrap_err();
//     assert_eq!(res, ContractError::NotSupported("Vote for Alliance LST".to_string()));
// }
