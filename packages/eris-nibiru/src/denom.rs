...
#[proto_message(type_url = "/nibiru.tokenfactory.v1.MsgCreateDenom")]
...
#[proto_message(type_url = "/nibiru.tokenfactory.v1.MsgCreateDenomResponse")]
...
#[proto_message(type_url = "/nibiru.tokenfactory.v1.MsgMint")]
pub struct MsgMint {
    #[prost(string, tag = "1")]
    pub sender: ::prost::alloc::string::String,
...
#[proto_message(type_url = "/nibiru.tokenfactory.v1.MsgBurn")]
pub struct MsgBurn {
    #[prost(string, tag = "1")]
    pub sender: ::prost::alloc::string::String,
    #[prost(message, optional, tag = "2")]
...
#[proto_message(type_url = "/nibiru.tokenfactory.v1.MsgBurnResponse")]
